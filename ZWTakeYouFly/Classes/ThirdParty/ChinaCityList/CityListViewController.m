...
@interface CityListViewController ()<UIGestureRecognizerDelegate,UISearchBarDelegate,UITextFieldDelegate,ButtonGroupViewDelegate,LXSegmentBtnViewDelegate>
{
...
//    CGFloat btnW = kScreen_Width/2;
    ...
    UIView *searchView = [[UIView alloc] initWithFrame:CGRectMake(0, 64 + 40, self.view.frame.size.width, 40*(self.view.frame.size.height/568))];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(nonnull NSIndexPath *)indexPath
{
    ...
    ZWCityDetailViewController *detail = [[ZWCityDetailViewController alloc]init];
    detail.title = [NSString stringWithFormat:@"%@详情",cityName];
    [self pushVc:detail];
...
{
    ZWCityDetailViewController *detail = [[ZWCityDetailViewController alloc]init];
    detail.title = [NSString stringWithFormat:@"%@详情",item.cityItem.titleName];
    [self pushVc:detail];
